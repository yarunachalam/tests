...
def test_create_update_vm_enable_usb(request, admin_session, image, keypair,
    ...
    assert 'usb' in updated_devices_data['devices']['inputs']['bus']
    assert 'tablet' in updated_devices_data['devices']['inputs']['name']
    assert 'tablet' in updated_devices_data['devices']['inputs']['type']
